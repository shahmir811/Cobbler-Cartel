<template>
    <div class="inventory-items-table-component-wrapping-div">
...
export default {
    ...
    methods: {
        ...mapActions({
            ...
            selectInventoryItemToUpdate: "inventory/selectInventoryItemToUpdate"
        }),
        selectItemToUpdate(id) {
            this.selectInventoryItemToUpdate(id);
        }, 
        onDeleteHandler(id) {
          this.$swal
            .fire({
            ...
            .then(result => {
                if (result.value) {
                    this.deleteInventoryItem(id).then(() => {
                        this.$swal.fire(
                            "Deleted!",
